...
public class NinjaHealth : MonoBehaviour
{
    ...
    private NinjaMovement movement;
    ...
    void Awake()
    {
        ...
        movement = GetComponent<NinjaMovement>();
    }
    ...
    public void TakeDamage(float amount, Vector2 attackerPosition)
    {
        ...
        if (movement.IsInParryWindow())
        {
            ...
            {
                attackerviking.TriggerParryStun(transform.position);
                attackerviking.ReceiveParryPostureDamage(movement.parryPostureDamage);
            }
